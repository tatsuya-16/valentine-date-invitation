...
class ValentineApp(QWidget):
    ...
    def initUI(self):
        ...
        self.setStyleSheet('background-color: #0000cd;')  # 濃い青色の背景
        ...
        # メッセージを表示
        label = QLabel('私とバレンタインデートに行きませんか?', self)
        ...
        # Yesボタン
        self.yes_btn = QPushButton('はい', self)
        ...
        # Noボタン
        self.no_btn = QPushButton('いいえ', self)
    ...
    def on_yes(self):
        self.label_result = QLabel('素晴らしい!すぐ迎えに行きます! ❤', self)
